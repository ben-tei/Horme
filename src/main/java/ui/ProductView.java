...
public class ProductView extends JPanel implements ActionListener{
	...
	public ProductView (ViewController vc, String loginText)
	{
		...
		//menu = new Menu(this.sl_container, this, loginText);
		
		JLabel lblUser = new JLabel("Connected as : " + loginText);
		sl_container.putConstraint(SpringLayout.NORTH, lblUser, 15, SpringLayout.NORTH, this);
		sl_container.putConstraint(SpringLayout.WEST, lblUser, 10, SpringLayout.WEST, this);
		this.add(lblUser);
		...
		sl_container.putConstraint(SpringLayout.NORTH, lblHorme, 10, SpringLayout.NORTH, this);
		sl_container.putConstraint(SpringLayout.WEST, lblHorme, 400, SpringLayout.WEST, this);
